...
export default class RecordController extends Controller {
    ...
    constructor() {
        ...
        this.recordPanelTitle = this.view.querySelector('.js-record-panel-title');
    ...
    startRecording() {
        ...
        this.mediaRecording.analyser.then(analyser => {
            ...
            this.recordPanelTitle.innerText = 'Recording a new memo';
            requestAnimationFrame(trackAudioVolume);
        });
    ...
    stopRecording() {
        ...
        this.recordPanelTitle.innerText = 'Record a new memo';
